    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)]">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Elige cómo atiendes hoy. Ejemplo: clientes llegan cada hora y tu equipo los atiende de
            uno en uno o en paralelo.
          </CardDescription>
        ...
        {activeModel === 'MM1' ? (
          <Form<Mm1FormValues>
            onSubmit={(data) => mm1.mutate(data, { onSuccess, onError })}
            useFormProps={{
          ...
          >
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <FormInput<Mm1FormValues>
                ...
                hint="Debe ser mayor que las llegadas"
                type="number"
                step="any"
              />
              <FormInput<Mm1FormValues>
        ...
        {activeModel === 'MM1K' ? (
          <Form<Mm1kFormValues>
            onSubmit={(data) => mm1k.mutate(data, { onSuccess, onError })}
            useFormProps={{
        ...
        {activeModel === 'MMS' ? (
          <Form<MmsFormValues>
            onSubmit={(data) => mms.mutate(data, { onSuccess, onError })}
            useFormProps={{
          ...
          >
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <FormInput<MmsFormValues>
                ...
                hint="Tu equipo debe poder cubrir las llegadas"
                type="number"
              />
        ...
        {activeModel === 'MMSK' ? (
          <Form<MmskFormValues>
            onSubmit={(data) => mmsk.mutate(data, { onSuccess, onError })}
            useFormProps={{
